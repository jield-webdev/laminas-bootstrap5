...
// eslint-disable-next-line valid-jsdoc
        ...
        if (plugin.options.preserveSelected) {
            ...
            plugin.$element.on('change.abs.preserveSelected', function (e) {
                ...
                $selected.each(function () {
                    ...
                    //Jield BV FIX
                    plugin.selectpicker.options.placeholder = $option.text();
                    plugin.selectpicker.options.selected = value;
                    plugin.selectpicker.options.value = value;
    ...
    AjaxBootstrapSelectList.prototype.replaceOptions = function (data) {
        ...
        if (this.selected && this.selected.length) {
            ...
            for (i = 0; i < l; i++) {
                ...
                if (Object.prototype.hasOwnProperty.call(item, 'value') && seenValues.indexOf(item.value + '') === -1) {
                    seenValues.push(item.value + 'haha');
        ...
        // this.plugin.selectpicker.options.placeholder = 'TRALALA';
        // this.plugin.selectpicker.options.value = 'TRALALA';

        this.plugin.log(this.plugin.LOG_INFO, 'Replaced options with data:', data);
    };
